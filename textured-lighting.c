...
#define CUBE_FRAG_FILE "textured-lighting-spot.frag"
...
int main(int argc, char **argv)
{
    ...
    /* SetUniformVec3fShaderProg(cubeProg, "dlight.ambient", &dlight.ambient); */
    /* SetUniformVec3fShaderProg(cubeProg, "dlight.diffuse", &dlight.diffuse); */
    /* SetUniformVec3fShaderProg(cubeProg, "dlight.specular", &dlight.specular); */
    /* SetUniformVec3fShaderProg(cubeProg, "dlight.dir", &dlight.dir); */

    /* SetUniformVec3fShaderProg(cubeProg, "light.ambient", &light.ambient); */
    /* SetUniformVec3fShaderProg(cubeProg, "light.diffuse", &light.diffuse); */
    /* SetUniformVec3fShaderProg(cubeProg, "light.specular", &light.specular); */
    /* SetUniformVec3fShaderProg(cubeProg, "light.pos", &light.pos); */
    /* SetUniformFloatShaderProg(cubeProg, "light.constant", light.constant); */
    /* SetUniformFloatShaderProg(cubeProg, "light.linear", light.linear); */
    /* SetUniformFloatShaderProg(cubeProg, "light.quadratic", light.quadratic); */
    ...
    SetUniformFloatShaderProg(cubeProg, "light.linear", light.linear);
    SetUniformFloatShaderProg(cubeProg, "light.quadratic", light.quadratic);
    SetUniformFloatShaderProg(cubeProg, "light.cutOff", cos(DegToRad(light.cutoff)));
    SetUniformFloatShaderProg(cubeProg, "light.outerCutOff", cos(DegToRad(light.outerCutoff)));
    ...
    while (!(glfwWindowShouldClose(win)))
    {
        ...
        {
            SetUniformVec3fShaderProg(cubeProg, "light.pos", cameraPos);
            SetUniformVec3fShaderProg(cubeProg, "light.dir", cameraFront);
        ...
        glBindVertexArray(lightVAO);
        {
            Mat4f lightModel = TranslateMat4f(&model, light.pos);
